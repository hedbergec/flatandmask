...
input_file <- if (length(args) >= 1) args[[1]] else "/Users/hedbergec/Dropbox/Work/Consult/Consult.Katz/ppd/flatandmask/test_data/test_ndjson.json"
output_folder <- if (length(args) >= 2) args[[2]] else "/Users/hedbergec/Dropbox/Work/Consult/Consult.Katz/ppd/flatandmask/test_output/r_correspondence_macos/test-ndjson"
